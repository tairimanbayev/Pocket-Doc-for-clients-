...
import com.project.pocketdoctor.util.setText
import com.project.pocketdoctor.viewmodels.EditProfileViewModel
import com.project.pocketdoctor.viewmodels.factories.EditProfileFactory
...
class EditProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        layout_toolbar.toolbar_title.text = getString(R.string.edit)
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == STORAGE_REQUEST_CODE && grantResults.isEmpty())
            Toast.makeText(
                this,
                "Необходимо разрешение для доступа к локальным файлам",
                Toast.LENGTH_SHORT
            ).show()
    }
